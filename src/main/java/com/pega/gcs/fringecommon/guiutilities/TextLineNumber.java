...
/**
 * This class will display line numbers for a related text component. The text component must use the same line height for each
 * line. TextLineNumber supports wrapped lines and will highlight the line number of the current line in the text component. This
 * class was designed to be used as a component added to the row header of a JScrollPane.
 */
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {

    private static final long serialVersionUID = -1156961053950744769L;
    ...
    /**
     * Set the update font property. Indicates whether this Font should be updated automatically when the Font of the related text
    ...
    /**
     * Specify the horizontal alignment of the digits within the component. Common values would be: <ul> <li>TextLineNumber.LEFT
     * <li>TextLineNumber.CENTER <li>TextLineNumber.RIGHT (default) </ul>
     * 
    ...
    public void paintComponent(Graphics graphics) {
        ...
        while (rowStartOffset <= endOffset) {
            ...
            try {
                ...
                int xoffset = getOffsetX(availableWidth, stringWidth) + insets.left;
                int yoffset = getOffsetY(rowStartOffset, fontMetrics);
                graphics.drawString(lineNumber, xoffset, yoffset);
    ...
    private int getOffsetY(int rowStartOffset, FontMetrics fontMetrics) throws BadLocationException {
        ...
        Rectangle rectangle = component.modelToView(rowStartOffset);
        int lineHeight = fontMetrics.getHeight();
        int ypos = rectangle.y + rectangle.height;
        int descent = 0;
