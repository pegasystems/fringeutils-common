...
public abstract class FilterTableHeaderPopupMenu<T> extends JPopupMenu {
    ...
    public JComponent getCheckBoxLabelMenuItemListJComponent() {
        ...
        JScrollPane scrollPane = new JScrollPane(checkBoxLabelMenuItemListJPanel,
                ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);

        JScrollBar verticalScrollBar = scrollPane.getVerticalScrollBar();
        // JScrollBar horizontalScrollBar = scrollPane.getHorizontalScrollBar();
        //
        // Dimension verticalScrollBarPreferredSize = verticalScrollBar.getPreferredSize();
        // Dimension horizontalScrollBarPreferredSize = horizontalScrollBar.getPreferredSize();
        // Dimension checkBoxLabelMenuItemListJPanelPreferredSize = checkBoxLabelMenuItemListJPanel.getPreferredSize();
        //
        // int vBarWidth = verticalScrollBarPreferredSize.width;
        // int hBarHeight = horizontalScrollBarPreferredSize.height + 3/* border size */;
        //
        // int compWidth = checkBoxLabelMenuItemListJPanelPreferredSize.width;
        // int compHeight = checkBoxLabelMenuItemListJPanelPreferredSize.height;
        //
    ...
    protected void applySearchText() {
        ...
        if ((searchText != null) && (!"".equals(searchText))) {
            ...
            for (CheckBoxMenuItemPopupEntry<T> checkBoxMenuItemPopupEntry : filterTableHeaderColumnEntrySet) {
                ...
                String entryText = checkBoxMenuItemPopupEntry.getItemText();
